...
anim_save("./gifs/collocation_over_years.gif")
```
...
animate(coll_circle_anim, fps = 25, duration = 50, width = 800, height = 600, end_pause = 100)
anim_save("./gifs/collocation_circle_over_years.gif")
```
...
animate(employment_rate_line, fps = 25, duration = 50, width = 800, height = 600, end_pause = 100)
anim_save("./gifs/employment_rate_line.gif")
```

```{r}
circle <- include_graphics("./gifs/collocation_circle_over_years.gif")
rate <- include_graphics("./gifs/employment_rate_line.gif")
```
