...
animate(coll_circle_anim, fps = 25, duration = 20, width = 800, height = 600, end_pause = 100)
anim_save("collocation_circle_over_years.gif")
```
...
animate(employment_rate_line, fps = 25, duration = 20, width = 800, height = 600, end_pause = 100)
anim_save("employment_rate_line.gif")
```

```{r}
include_graphics("collocation_circle_over_years.gif")
include_graphics("employment_rate_line.gif")
```
