...
#  ) +
```
As we might have expected, this changes in political trends corresponds with local minimum values for the unemployment rates (years 1995 and 2013).
...
senate_seats
```
We can now use Shiny to create an interactive view that will dinamically display the senate seats for all election years.
